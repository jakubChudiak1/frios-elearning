...
class ExerciseFormat extends Block {
  static create(value) {
    let node = super.create();
    node.setAttribute("class", "ql-exercise");
    return node;
  }
  ...
  formatAt(index, length, name, value) {
    ...
    if (next instanceof ExerciseFormat) {
      next.formatAt(
        0,
...
ExerciseFormat.blotName = "exercise";
ExerciseFormat.tagName = "div.exercise";
export { ExerciseFormat };
