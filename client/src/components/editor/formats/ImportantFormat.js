...
class ImportantFormat extends Block {
  static create(value) {
    let node = super.create();
    node.setAttribute("class", "ql-important");
    return node;
  }
  ...
  formatAt(index, length, name, value) {
    ...
    if (next instanceof ImportantFormat) {
      next.formatAt(
        0,
...
ImportantFormat.blotName = "important";
ImportantFormat.tagName = "div.important";

export { ImportantFormat };
